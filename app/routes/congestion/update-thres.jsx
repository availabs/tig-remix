...
// export function congestionCalculatorNonRecurrent(filteroutCongetionTime, tmcEpochTime, avgTMCCongetionTime) {
//     const computedDifference = filteroutCongetionTime.map((t) => {
//         // console.log(avgTMCCongetionTime);
//       return {
//         [t.tmc]: tmcEpochTime[`${t.tmc}`].map((te) =>
//           Math.max(te - Math.max(t.avg_time, avgTMCCongetionTime[`${t.tmc}`]), 0)
//         ),
//       };
//     });
//     return Object.assign({}, ...computedDifference);
...
// //   console.log(finalDataTime);
//   let avgTMCCongetionTime = Object.assign({}, ...tmcArray.map((d) => {
//     return {
//         [d] : finalDataTime[d].reduce((a, b) => a + b, 0) /288
//     };
//   }));
//   // console.log(finalDataSpeed);
//   // tmcArray.map((tmc) => {
//   //     finalDataSpeed[tmc].map((d, i) => {
//   //         if(i < 2) ;
//   //         else {
//   //             finalDataSpeed[tmc][i] = (finalDataSpeed[tmc][i]+finalDataSpeed[tmc][i-1]+finalDataSpeed[tmc][i-2])/3;
//   //         }
//   //     });
//   // })
//   // avgTMCSpeed.map((d) => {
...
//   return { tmcArray, months, wholeData, avgTMCSpeed, avgTMCTime, wholeDataTime, wholeDataTimeNonRecurrent};
// }

// export function selectedPlotTypeFunction(wholeData, avgTMCSpeed, avgTMCTime, wholeDataTime, wholeDataTimeNonRecurrent, selectedPlotType) {
//     // console.log("selectedPlotType called", selectedPlotType);
...
// export function Mean15Minute(tmcArray, months, wholeData, avgTMCData, selectedPlotType, j) {
...
//   let typeCheck = true;
//   if(selectedPlotType == "Congestion-time" || selectedPlotType == "Non-recurrent-congestion" ) {
//     typeCheck = true;
//   }

//   months.forEach((m) => {
//     let prev = 0, prev_index = 0;
//     tmcArray.forEach((tmc) => {
...
//           if(typeCheck && ((sum != null && sum > 0) || (sum == null))) {
//             if(prev == 0) {
//                 prev_index = i+j;
//             }
//             prev++;
...
//                     updatedWholeData[m][tmc][i+j-k] = updatedAvgTMCSpeed[tmc][i+j-k];
//                 }
//             }
...
// export function HarmonicMean15Minute(tmcArray, months, wholeData, avgTMCData, selectedPlotType, j) {
//   var updatedAvgTMCSpeed = cloneDeep(avgTMCData);
//   var updatedWholeData = cloneDeep(wholeData);
//   const sumDefaultValue = selectedPlotType == "Speed"? null : 0;
//   // console.log("Mean", updatedAvgTMCSpeed)
...
//   wholeData,
//   avgTMCData,
//   selectedFuctionName, selectedPlotType
// ) {
...
//     return { updatedAvgTMCSpeed, updatedWholeData };
//   } else if (selectedFuctionName == "Trailling-15-mean") {
//      j = 0;
//     let { updatedAvgTMCSpeed, updatedWholeData } = Mean15Minute(
//       tmcArray,
//       months,
//       wholeData,
//       avgTMCData, selectedPlotType, j
//     );
//     return { updatedAvgTMCSpeed, updatedWholeData };
//   } else if (selectedFuctionName == "Surrounding-15-mean") {
//     j = 1;
//     let { updatedAvgTMCSpeed, updatedWholeData } = Mean15Minute(
//       tmcArray,
//       months,
...
//     );
//     return { updatedAvgTMCSpeed, updatedWholeData };
//   } else if (selectedFuctionName == "Trailling-15-harmonicMean") {
//     j = 0;
...
//     );
//     return { updatedAvgTMCSpeed, updatedWholeData };
//   } else if (selectedFuctionName == "Surrounding-15-harmonicMean") {
//     j = 1;
...
//   let { tmcArray, months, wholeData, avgTMCSpeed, avgTMCTime, wholeDataTime, wholeDataTimeNonRecurrent} =
//     useLoaderData();
//   const [selectedTmc, changeTmc] = useState(tmcArray[0]);

//   const input_functions_list = ["raw", "Trailling-15-mean", "Surrounding-15-mean", "Trailling-15-harmonicMean", "Surrounding-15-harmonicMean"];
...
//       xScale={{ type: "linear" }}
//       yScale={{ type: "linear", stacked: ("stacked", false), min:selectedPlotType=="Speed"? 20 : 0 }}
//       yFormat=" >-.2f"
//       curve="monotoneX"
//       axisTop={null}
//       axisRight={{
...
//             {
//               on: "hover",
//               on: "hover", function(event, legendItem){
//                 var options = this.options || {};
//                 var hoverOptions = options.hover || {};
//                 var ci = this.chart;
//                 var hoveredDatasetIndex = legendItem.datasetIndex;
