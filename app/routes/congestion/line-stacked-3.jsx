...
// export function TMCPlotData(tmcArray, months, wholeData, avgTMCSpeed, selectedTmc) {
...
//         // const {updatedWholeData, updatedAvgTMCSpeed} = selecte   dFunction(tmcArray, months, wholeData, avgTMCSpeed, selectedFuctionName);
//     let data1 = TMCPlotData(tmcArray, months, wholeData, avgTMCSpeed, selectedTmc);
//     // console.log(data1);
...
//             //     <pre>{JSON.stringify(data1, null, 3)}</pre>
//             // </div>
//         }       
