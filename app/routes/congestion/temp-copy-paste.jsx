...
//               if (current < Math.max((finalAVGDataTime[t.tmc][i]*0.6), 20)) { prev++; }
            
//               if (current >= Math.max((finalAVGDataTime[t.tmc][i]*0.6), 20)) {
//                   if (prev < w) {
//                         console.log("Removed!!!");
//                       for (let k = 1; k <= prev; k++) {
//                           updatedWholeData[m][t.tmc][i - k] = 
//                               Math.max(finalAVGDataTime[t.tmc][i - k], null);
//                       }
//                   }
...
//         updatedWholeData = Denoiser(tmcArray, months, wholeData, filteroutThresholdTime, 1, avgTMCData);
      
//       } else if (selectedFuctionName == "Denoiser-w-3") {
      
//         updatedWholeData = Denoiser(tmcArray, months, wholeData, filteroutThresholdTime, 3, avgTMCData);
      
//       } else if (selectedFuctionName == "Denoiser-w-5") {
      
//         updatedWholeData = Denoiser(tmcArray, months, wholeData, filteroutThresholdTime, 5, avgTMCData);
