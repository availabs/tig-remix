...
//     var updatedAvgTMCSpeed = avgTMCSpeed, updatedWholeData = wholeData;
//     // console.log("Mean", updatedAvgTMCSpeed)
//     tmcArray.map((tmc) => {
//         avgTMCSpeed[tmc].map((d, i) => {
//             if(i < 2) ;
//             else {
//                 let t1 = avgTMCSpeed[tmc][i];
//                 let t2 = avgTMCSpeed[tmc][i-1];
//                 let t3 = avgTMCSpeed[tmc][i-2];
//                 let count = 0;
//                 let sum = 0;
...
//                 if(i < 2) ;
//                 else {
//                     let t1 = wholeData[m][tmc][i];
//                     let t2 = wholeData[m][tmc][i-1];
//                     let t3 = wholeData[m][tmc][i-2];
//                     let count = 0;
//                     let sum = 0;
...
//                 if(t1!= 0) {sum += 1/t1; count++;}
//                 if(t2!= 0) {sum += 1/t2; count++;}
//                 if(t3!= 0) {sum += 1/t3; count++;}
...
// export function selectedFunction(tmcArray, months, wholeData, avgTMCSpeed, selectedFuctionName) {
//     if(selectedFuctionName == "15-mean") {
//         let {updatedAvgTMCSpeed, updatedWholeData} = Mean15Minute(tmcArray, months, wholeData, avgTMCSpeed);
//         return {updatedAvgTMCSpeed, updatedWholeData};
//     } 
    
//     else if (selectedFuctionName == "15-harmonicMean") {
//         var {updatedAvgTMCSpeed, updatedWholeData} = HarmonicMean15Minute(tmcArray, months, wholeData, avgTMCSpeed);
//         return {updatedAvgTMCSpeed, updatedWholeData};
...
// export function TMCPlotData(tmcArray, months, updatedWholeData, updatedAvgTMCSpeed, selectedTmc) {
//     let data1 = 
//     months.map((t) => {
//         return {
//           "id": t,
...
//     const [selectedFuctionName, changeFunction] = useState(input_functions_list[0]);

//     let {updatedAvgTMCSpeed, updatedWholeData} = selectedFunction(tmcArray, months, wholeData, avgTMCSpeed, selectedFuctionName);
//     const data1 = TMCPlotData(tmcArray, months, updatedWholeData, updatedAvgTMCSpeed, selectedTmc);
