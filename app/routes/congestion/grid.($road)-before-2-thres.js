...
//   var finalAVGDataTime = Object.assign(
//     {},
//     ...tmcArray.map((tmc) => {
//       return {
//         [tmc]: [],
...
//   avgTMCSpeed.map((d) => {
//     finalAVGDataTime[d.tmc].push(d.value);
//   });
...
//   return { tmcArray, months, wholeData, roadsNames, filteroutThresholdTime, finalAVGDataTime};
// }
...
//     updatedWholeData = Denoiser(tmcArray, months, wholeData, filteroutThresholdTime, 1, finalAVGDataTime);
  
//   } else if (selectedFuctionName == "Denoiser-w-3") {
  
//     updatedWholeData = Denoiser(tmcArray, months, wholeData, filteroutThresholdTime, 3, finalAVGDataTime);
  
//   } else if (selectedFuctionName == "Denoiser-w-5") {
  
//     updatedWholeData = Denoiser(tmcArray, months, wholeData, filteroutThresholdTime, 5, finalAVGDataTime);
...
//   let { tmcArray, wholeData, months, roadsNames, filteroutThresholdTime, finalAVGDataTime} = useLoaderData();
...
//           {/* <div className="">
//             <pre>{JSON.stringify(roads, null, 3)}</pre>
//           </div> */}
